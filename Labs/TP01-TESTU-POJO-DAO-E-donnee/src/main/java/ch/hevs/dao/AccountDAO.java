...
public class AccountDAO {
	...
	public static Account search(long id) throws BankException, ClassNotFoundException {
		Account result = null;
		try {
	...
	public static void saveOrUpdate(Account c) throws BankException, ClassNotFoundException {
		try {
			Connection connexion = ConnexionManager.getConnexion();
